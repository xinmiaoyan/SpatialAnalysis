...
PIPELINE_NAME=02_spaceranger_count_s3
...
image_Array=(
    /rsrch6/home/genomic_med/lwang22_lab/03_SharedFolder_from_Xinmiao_to_Jiahui/CytAsist/S-04-021004_s3.tif
    /rsrch6/home/genomic_med/lwang22_lab/03_SharedFolder_from_Xinmiao_to_Jiahui/CytAsist/S-11-022505_s3.tif
    )
...
#     /rsrch6/home/genomic_med/lwang22_lab/03_SharedFolder_from_Xinmiao_to_Jiahui/Data/S04_S1.json
#     /rsrch6/home/genomic_med/lwang22_lab/03_SharedFolder_from_Xinmiao_to_Jiahui/Data/S11_S1.json
#     )
...
for i in "${!fastq_path_Array[@]}"; do 
    ...
    JOBFOLDER=${OutDir}/${sample}_without_align
    if [ ! -d $JOBFOLDER ]; then
        mkdir -p $JOBFOLDER
    fi
